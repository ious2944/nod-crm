...
export function ContactDialog({
  ...
  return createPortal(
    ...
    >
      {/* Clic sur l'overlay → fermer. tabIndex={-1} : hors du cycle Tab. */}
      <button
        type="button"
        aria-label="Fermer"
        tabIndex={-1}
      ...
      <div className="pointer-events-none flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4">
        {/*
          Le panneau porte role="dialog" et aria-modal="true" pour que les
        ...
        */}
        <div
          ...
          className="pointer-events-auto nod-rise relative w-full max-w-lg rounded-t-2xl border border-border-subtle bg-surface p-5 shadow-dialog sm:rounded-2xl"
        >
